...
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-900 mb-2">Galeri Peta Interaktif</h2>
    <p class="text-gray-600">Koleksi peta dan visualisasi data geografis Sesar Jawa Bagian Barat</p>
</div>
