...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            Buat Proyek Survey Baru
        </h1>
        <p class="mt-1 text-sm text-gray-600">
            Isi detail di bawah untuk memulai proyek baru.
        </p>
    </div>

    <form method="POST" action="{{ route('projects.store') }}" class="bg-white shadow-lg rounded-lg p-6 sm:p-8">
        @csrf
        <div class="space-y-6">
            <div>
        ...
        <div class="mt-8 pt-5 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-blue-700 transition">Simpan Proyek</button>
        </div>
    </form>
</div>
@endsection
